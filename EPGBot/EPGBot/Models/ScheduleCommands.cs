...
namespace EPGBot.Models
{
    ...
    {
        public const string Now = "Ver o que está passando agora em todos os canais";
        public static readonly List<string> NowSynonyms = new List<string> { "todos os canais" };

        public const string NowChannel = "Ver o que está passando agora em um canal específico";
